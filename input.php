...
<!-- Editable table -->
<div class="card">
  <h7 class="card-header text-center font-weight-bold text-uppercase py-4"><i>Enter number of students admitted by programme/course and sex</i></h7>
  <div class="card-body">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
        ...
        <tbody>
          <tr>
            ...
            <td class="pt-3-half" contenteditable="false"> <select name="class_type" id="Institution Type" class=" form-control input-lg pt-3-half" style="" autocomplete="off" required="">
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        ...
        <a href="input1.php"><button type="button" class="btn btn-primary">Proceed to next page</button></a>
